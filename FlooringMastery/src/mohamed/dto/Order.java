...
public class Order {
    //No need of dependcy injection here, right? we only need one specific tax/product class no need of abstraction
    Tax tax = new Tax();
	...
	public String toString() {
		return "Order [tax=" + tax + ", product=" + product + ", orderNumber=" + orderNumber + ", customerName="
				+ customerName + ", state=" + state + ", taxRate=" + taxRate + ", productType=" + productType
				+ ", area=" + area + ", costPerSqFt=" + costPerSqFt + ", laborCostPerSqFt=" + laborCostPerSqFt
				+ ", materialCost=" + materialCost + ", laborCost=" + laborCost + ", totalTax=" + totalTax
				+ ", totalCost=" + totalCost + ", timeStamp=" + timeStamp + "]";
	}
}
